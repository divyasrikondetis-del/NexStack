      ...
      <div style={{ maxWidth: "800px", margin: "0 auto" }}>
        ...
        <form onSubmit={handleSubmit}>
          <div style={{ marginBottom: "20px" }}>
            <label style={{ display: "block", marginBottom: "8px", fontWeight: 600 }}>{t('jobTitle') || 'Job Title'}</label>
            <input
              value={title}
          ...
          <div style={{ marginBottom: "20px" }}>
            <label style={{ display: "block", marginBottom: "8px", fontWeight: 600 }}>{t('company') || 'Company'}</label>
            <input
              value={company}
          ...
          <div style={{ marginBottom: "20px" }}>
            <label style={{ display: "block", marginBottom: "8px", fontWeight: 600 }}>{t('location') || 'Location'}</label>
            <input
              value={location}
          ...
          <div style={{ marginBottom: "20px" }}>
            <label style={{ display: "block", marginBottom: "8px", fontWeight: 600 }}>{t('salary') || 'Salary'}</label>
            <input
              value={salary}
          ...
          <div style={{ marginBottom: "20px" }}>
            <label style={{ display: "block", marginBottom: "8px", fontWeight: 600 }}>{t('about') || 'Description'}</label>
            <textarea
              value={description}
          ...
          <div style={{ marginBottom: "24px" }}>
            <label style={{ display: "block", marginBottom: "8px", fontWeight: 600 }}>{t('requirements') || 'Requirements'}</label>
            <input
              value={requirements}
